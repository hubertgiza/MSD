		...
		for (x = 0; x < points.length; ++x) {
			for (y = 0; y < points[x].length; ++y) {
				if (points[x][y].getState() != 0) {
					...
					case 1:
						g.setColor(new Color(0.0f, 0.0f, 1.0f, 0.40f));
						break;
					case 2:
						g.setColor(new Color(0.0f, 0.0f, 1.0f, 0.45f));
						break;
					case 3:
						g.setColor(new Color(0.0f, 0.0f, 1.0f, 0.50f));
						break;						
					case 4:
						g.setColor(new Color(0.0f, 0.0f, 1.0f, 0.55f));
						break;						
					case 5:
						g.setColor(new Color(0.0f, 0.0f, 1.0f, 0.60f));
						break;						
					case 6:
